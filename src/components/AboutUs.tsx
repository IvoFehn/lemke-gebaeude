...
const AboutUs = (props: Props) => {
  return (
    <div className="mt-5  container mx-auto w-full flex ">
      <div className="basis-1/2 w-full">
        ...
        <div
          ...
          className="grid grid-cols-2 text-colorSecondary px-32 gap-4 -translate-y-12"
        >
          <div className="flex flex-col items-center justify-center bg-white shadow-lg rounded-xl p-4">
            <CountUpComponent
              countUpTo={560}
      ...
      <div className="basis-1/2 w-full h-full">
        ...
        <div className="border-b-2 border-dotted pb-2 border-colorText pt-6">
          <GiVacuumCleaner
            style={{
              fontSize: "4rem",
              marginBottom: "1rem",
