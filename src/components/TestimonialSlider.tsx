  ...
  return (
    <div className="w-full max-w-3xl mx-auto text-center">
      ...
      <div className="relative h-32 ">
        <div
          className="
         absolute top-0 left-1/2 -translate-x-1/2 4k:w-[480px] 2k:w-screen h-[480px] pointer-events-none before:absolute before:inset-0 before:bg-gradient-to-b before:from-colorSecondary/25 before:via-colorSecondary/5 before:via-25% before:to-colorSecondary/0 before:to-75% before:rounded-full before:-z-10"
        >
        ...
        {testimonials.map((testimonial, index) => (
          <button
            ...
            className={`inline-flex justify-center whitespace-nowrap rounded-full px-3 py-1.5 m-1.5 text-xs shadow-sm focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 transition-colors duration-150 ${
              active === index
                ? "bg-colorSecondary text-white shadow-indigo-950/10"
                : "bg-colorSecondary/20 hover:bg-colorSecondary/50 text-slate-900"
            }`}
            onClick={() => {
              setActive(index);
              setAutorotate(false);
