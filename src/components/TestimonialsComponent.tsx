...
const TestimonialsComponent = (props: Props) => {
  return (
    <section className="container mx-auto shadow-sm border-colorBorderLightGrey border-solid border-2 rounded-3xl flex mt-3 w-full">
      <div className="p-3">
        <Image
      ...
      <div className="text-colorPrimary flex justify-center items-center flex-col w-3/4">
