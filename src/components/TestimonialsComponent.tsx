...
const TestimonialsComponent = (props: Props) => {
  return (
    <section className="4k:px-[20vw] xl:px-0 mx-auto shadow-sm border-colorBorderLightGrey border-solid border-2 rounded-3xl flex mt-3 lg:flex-col lg:items-center lg:justify-center lg:px-4 lg:border-none lg:shadow-none">
      <div className="p-3">
        <Image
      ...
      <div className="text-colorPrimary flex justify-center items-center flex-col w-3/4 lg:pt-24">
